...
from segmentation_models_pytorch_3branch.encoders import get_encoder
from segmentation_models_pytorch_3branch.base import (
    SegmentationModel,
    SegmentationHead,
    ClassificationHead,
)
from .decoder import MAnetDecoder
from segmentation_models_pytorch_3branch.base.modules import Mixer_struc
...
class MAnet(SegmentationModel):
    ...
    def __init__(
        ...
        self.segmentation_head_7 = SegmentationHead(
            in_channels=decoder_channels[-1],
            out_channels=classes,
            activation=activation,
            kernel_size=3,
        )
        self.SE_output = nn.Sequential(
        ...
        self.MLP_Mixer=Mixer_struc(
            patches=16,
            token_dim=32,
        )
        self.weight=nn.Conv2d(4, 1, 1)
        self.fusion=nn.Conv2d(3*classes, classes, 1)
